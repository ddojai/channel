package com.github.ddojai.microservices.composite.product.services;
...
import com.github.ddojai.microservices.api.core.recommendation.RecommendationService;
import com.github.ddojai.microservices.api.core.review.Review;
import com.github.ddojai.microservices.api.core.review.ReviewService;
...
import com.github.ddojai.microservices.util.http.HttpErrorInfo;
...
public class ProductCompositeIntegration implements ProductService, RecommendationService,
    ...
    public List<Recommendation> getRecommendations(int productId) {
        ...
        try {
            ...
            LOG.warn("Got an exception while requesting recommendations, return zero " +
                "recommendations: {}", ex.getMessage());
